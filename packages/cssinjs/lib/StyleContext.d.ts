...
import { JSXElement, Component, Accessor } from 'solid-js';
...
declare const StyleContext: import("solid-js").Context<Accessor<StyleContextProps>>;
export type StyleProviderProps = Partial<StyleContextProps> & {
    children?: JSXElement;
};
export declare const StyleProvider: Component<StyleProviderProps>;
